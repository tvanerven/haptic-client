...
class ColorConverter:
    ...
    def _parse_colors(self):
        ...
        r_scaled = int((self.color['color']['r'] / 255) * self.color['intensity'])
        g_scaled = int((self.color['color']['g'] / 255) * self.color['intensity'])
        b_scaled = int((self.color['color']['b'] / 255) * self.color['intensity'])
        self._data.append(f"[L,9:{r_scaled}]")
        self._data.append(f"[L,6:{g_scaled}]")
        self._data.append(f"[L,4:{b_scaled}]")
