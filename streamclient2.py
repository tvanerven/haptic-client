...
def websocket_client():
    websocket_url = "ws://localhost:8000/ws/send/streamer/test/monkey"  # Change this URL to your WebSocket server
    requests.post(url='http://localhost:8000/vest/pairing', params={'client': 'test', 'secret': 'monkey'}, headers={'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ0ZXN0IiwiZXhwIjoxNzI5MjQ4OTc4fQ.pDx_skQ2VCdcNju1_PZMwk-7z_Nq_MXXmbkURewHiqo'})
    try:
